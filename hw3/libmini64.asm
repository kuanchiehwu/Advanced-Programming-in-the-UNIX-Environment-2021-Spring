extern _setjmp_sigmask		; void _setjmp_sigmask(jmp_buf env);
extern _longjmp_sigmask		; void _longjmp_sigmask(jmp_buf env);
...
; jmp_buf address is store in rdi
; jmp_buf store rbx, rsp, rbp, r12, r13, r14, r15, return address
	global setjmp:function
setjmp:
	pop rax ; put return address in rax
	mov [rdi], rbx
	mov [rdi + 8], rsp
	mov [rdi + 16], rbp
	mov [rdi + 24], r12
	...
	call _setjmp_sigmask wrt ..plt
	
	mov rax, 0 ; return value is passed by rax
	ret
...
longjmp:
	...
	mov r14, [rdi + 40]
	mov r15, [rdi + 48]
	mov rax, [rdi + 56] ; put setjmp return address in rax
	push rax

	call _longjmp_sigmask wrt ..plt

	mov rax, rsi ; return value is passed by rax
	ret
