...
typedef struct jmp_buf_s{
	// RBX, RSP, RBP, R12, R13, R14, R15, and the return address (to the caller of setjmp)
	long long reg[8];
	sigset_t mask;
} jmp_buf[1];
...
long sys_geteuid();
long sys_getegid();
long sys_rt_sigprocmask(int how, sigset_t *nset, sigset_t *oldset, size_t sigsetsize);
